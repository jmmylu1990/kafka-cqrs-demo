 ...
 * <p>
 * 當 Spring Boot 應用程式啟動時，檢查 MySQL 數據庫中是否存在預設商品及錢包記錄。
 * </p>
 */
@Component
@Slf4j
public class AxonDatabaseInitializer implements CommandLineRunner {
    ...
    public AxonDatabaseInitializer(AxonInventoryRepository inventoryRepository, AxonWalletRepository walletRepository) {
